...
namespace Mliybs.Minecraft.Fabric.Generator
{
    public static class GeneratorHelper
    {
        ...
        public static string GetQualifiedName(this ISymbol symbol, bool removeClassGeneric = false)
        {
            var name = symbol.GetFullyQualifiedName();
...
#nullable enable
        public static string NestedClassCompletion(this ITypeSymbol type, string content, bool? onlyUseInLibrary = null, string? implements = null, bool removeClassGeneric = false)
        {
            ...
            for (int i = list.Count - 1; i >= 0; i--)
            {
                ...
                if (implements is null) builder.AppendLine(list[i].GetQualifiedName(removeClassGeneric));
                else
                {
                    builder.Append(list[i].GetQualifiedName(removeClassGeneric));
                    builder.Append(" : ");
