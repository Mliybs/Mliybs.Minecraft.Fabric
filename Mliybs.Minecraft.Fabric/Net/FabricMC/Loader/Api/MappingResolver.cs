...
public partial class MappingResolver : JavaClass, IClassRef, IFromHandle<MappingResolver>
{
    public static nint ClassRef { get; } = FindClass("net/fabricmc/loader/api/MappingResolver");

    internal static readonly nint MapClassName_ = GetMethodID(ClassRef, "mapClassName", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;");

    internal static readonly nint MapMethodName_ = GetMethodID(ClassRef, "mapMethodName", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;");

    internal static readonly nint MapFieldName_ = GetMethodID(ClassRef, "mapFieldName", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;");
